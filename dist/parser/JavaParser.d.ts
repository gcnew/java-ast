...
export declare class JavaParser extends Parser {
    ...
    static readonly RULE_extendsList = 7;
    static readonly RULE_implementsList = 8;
    static readonly RULE_permitsList = 9;
    static readonly RULE_classDeclaration = 10;
    static readonly RULE_typeParameters = 11;
    static readonly RULE_typeParameter = 12;
    static readonly RULE_typeBound = 13;
    static readonly RULE_enumDeclaration = 14;
    static readonly RULE_enumConstants = 15;
    static readonly RULE_enumConstant = 16;
    static readonly RULE_enumBodyDeclarations = 17;
    static readonly RULE_interfaceDeclaration = 18;
    static readonly RULE_classBody = 19;
    static readonly RULE_interfaceBody = 20;
    static readonly RULE_classBodyDeclaration = 21;
    static readonly RULE_memberDeclaration = 22;
    static readonly RULE_methodDeclaration = 23;
    static readonly RULE_methodBody = 24;
    static readonly RULE_typeTypeOrVoid = 25;
    static readonly RULE_genericMethodDeclaration = 26;
    static readonly RULE_genericConstructorDeclaration = 27;
    static readonly RULE_constructorDeclaration = 28;
    static readonly RULE_fieldDeclaration = 29;
    static readonly RULE_interfaceBodyDeclaration = 30;
    static readonly RULE_interfaceMemberDeclaration = 31;
    static readonly RULE_constDeclaration = 32;
    static readonly RULE_constantDeclarator = 33;
    static readonly RULE_interfaceMethodDeclaration = 34;
    static readonly RULE_interfaceMethodModifier = 35;
    static readonly RULE_genericInterfaceMethodDeclaration = 36;
    static readonly RULE_interfaceCommonBodyDeclaration = 37;
    static readonly RULE_variableDeclarators = 38;
    static readonly RULE_variableDeclarator = 39;
    static readonly RULE_variableDeclaratorId = 40;
    static readonly RULE_variableInitializer = 41;
    static readonly RULE_arrayInitializer = 42;
    static readonly RULE_classOrInterfaceType = 43;
    static readonly RULE_typeRef = 44;
    static readonly RULE_typeArgument = 45;
    static readonly RULE_qualifiedNameList = 46;
    static readonly RULE_formalParameters = 47;
    static readonly RULE_receiverParameter = 48;
    static readonly RULE_formalParameterList = 49;
    static readonly RULE_formalParameter = 50;
    static readonly RULE_lastFormalParameter = 51;
    static readonly RULE_lambdaLVTIList = 52;
    static readonly RULE_lambdaLVTIParameter = 53;
    static readonly RULE_qualifiedName = 54;
    static readonly RULE_literal = 55;
    static readonly RULE_integerLiteral = 56;
    static readonly RULE_floatLiteral = 57;
    static readonly RULE_altAnnotationQualifiedName = 58;
    static readonly RULE_annotation = 59;
    static readonly RULE_elementValuePairs = 60;
    static readonly RULE_elementValuePair = 61;
    static readonly RULE_elementValue = 62;
    static readonly RULE_elementValueArrayInitializer = 63;
    static readonly RULE_annotationTypeDeclaration = 64;
    static readonly RULE_annotationTypeBody = 65;
    static readonly RULE_annotationTypeElementDeclaration = 66;
    static readonly RULE_annotationTypeElementRest = 67;
    static readonly RULE_annotationMethodOrConstantRest = 68;
    static readonly RULE_annotationMethodRest = 69;
    static readonly RULE_annotationConstantRest = 70;
    static readonly RULE_defaultValue = 71;
    static readonly RULE_moduleDeclaration = 72;
    static readonly RULE_moduleBody = 73;
    static readonly RULE_moduleDirective = 74;
    static readonly RULE_requiresModifier = 75;
    static readonly RULE_recordDeclaration = 76;
    static readonly RULE_recordHeader = 77;
    static readonly RULE_recordComponentList = 78;
    static readonly RULE_recordComponent = 79;
    static readonly RULE_recordBody = 80;
    static readonly RULE_block = 81;
    static readonly RULE_blockStatement = 82;
    static readonly RULE_localVariableDeclaration = 83;
    static readonly RULE_identifier = 84;
    static readonly RULE_localTypeDeclaration = 85;
    static readonly RULE_statement = 86;
    static readonly RULE_catchClause = 87;
    static readonly RULE_catchType = 88;
    static readonly RULE_finallyBlock = 89;
    static readonly RULE_resourceSpecification = 90;
    static readonly RULE_resources = 91;
    static readonly RULE_resource = 92;
    static readonly RULE_switchBlockStatementGroup = 93;
    static readonly RULE_switchLabel = 94;
    static readonly RULE_forControl = 95;
    static readonly RULE_forInit = 96;
    static readonly RULE_enhancedForControl = 97;
    static readonly RULE_parExpression = 98;
    static readonly RULE_expressionList = 99;
    static readonly RULE_methodCall = 100;
    static readonly RULE_expression = 101;
    static readonly RULE_pattern = 102;
    static readonly RULE_lambdaExpression = 103;
    static readonly RULE_lambdaParameters = 104;
    static readonly RULE_lambdaBody = 105;
    static readonly RULE_primary = 106;
    static readonly RULE_switchExpression = 107;
    static readonly RULE_switchLabeledRule = 108;
    static readonly RULE_guardedPattern = 109;
    static readonly RULE_switchRuleOutcome = 110;
    static readonly RULE_classType = 111;
    static readonly RULE_creator = 112;
    static readonly RULE_createdName = 113;
    static readonly RULE_innerCreator = 114;
    static readonly RULE_arrayCreatorRest = 115;
    static readonly RULE_classCreatorRest = 116;
    static readonly RULE_explicitGenericInvocation = 117;
    static readonly RULE_typeArgumentsOrDiamond = 118;
    static readonly RULE_nonWildcardTypeArgumentsOrDiamond = 119;
    static readonly RULE_nonWildcardTypeArguments = 120;
    static readonly RULE_typeList = 121;
    static readonly RULE_typeType = 122;
    static readonly RULE_primitiveType = 123;
    static readonly RULE_typeArguments = 124;
    static readonly RULE_superSuffix = 125;
    static readonly RULE_explicitGenericInvocationSuffix = 126;
    static readonly RULE_arguments = 127;
    ...
    extendsList(): ExtendsListContext;
    implementsList(): ImplementsListContext;
    permitsList(): PermitsListContext;
...
export declare class ExtendsListContext extends ParserRuleContext {
...
export declare class ImplementsListContext extends ParserRuleContext {
...
export declare class PermitsListContext extends ParserRuleContext {
...
export declare class ClassDeclarationContext extends ParserRuleContext {
    ...
    implementsList(): ImplementsListContext | undefined;
    permitsList(): PermitsListContext | undefined;
    constructor(parent: ParserRuleContext | undefined, invokingState: number);
    get ruleIndex(): number;
    enterRule(listener: JavaParserListener): void;
    exitRule(listener: JavaParserListener): void;
...
export declare class InterfaceDeclarationContext extends ParserRuleContext {
    ...
    interfaceBody(): InterfaceBodyContext;
    typeParameters(): TypeParametersContext | undefined;
    extendsList(): ExtendsListContext | undefined;
    permitsList(): PermitsListContext | undefined;
    constructor(parent: ParserRuleContext | undefined, invokingState: number);
    get ruleIndex(): number;
    enterRule(listener: JavaParserListener): void;
