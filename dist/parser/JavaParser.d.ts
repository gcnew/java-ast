...
export declare class JavaParser extends Parser {
    ...
    static readonly RULE_qualifiedNameList = 45;
    static readonly RULE_formalParameters = 46;
    static readonly RULE_receiverParameter = 47;
    ...
    static readonly RULE_lambdaLVTIList = 51;
    static readonly RULE_lambdaLVTIParameter = 52;
    static readonly RULE_qualifiedName = 53;
    static readonly RULE_literal = 54;
    static readonly RULE_integerLiteral = 55;
    static readonly RULE_floatLiteral = 56;
    static readonly RULE_altAnnotationQualifiedName = 57;
    static readonly RULE_annotation = 58;
    static readonly RULE_elementValuePairs = 59;
    static readonly RULE_elementValuePair = 60;
    static readonly RULE_elementValue = 61;
    static readonly RULE_elementValueArrayInitializer = 62;
    static readonly RULE_annotationTypeDeclaration = 63;
    static readonly RULE_annotationTypeBody = 64;
    static readonly RULE_annotationTypeElementDeclaration = 65;
    static readonly RULE_annotationTypeElementRest = 66;
    static readonly RULE_annotationMethodOrConstantRest = 67;
    static readonly RULE_annotationMethodRest = 68;
    static readonly RULE_annotationConstantRest = 69;
    static readonly RULE_defaultValue = 70;
    static readonly RULE_moduleDeclaration = 71;
    static readonly RULE_moduleBody = 72;
    static readonly RULE_moduleDirective = 73;
    static readonly RULE_requiresModifier = 74;
    static readonly RULE_recordDeclaration = 75;
    static readonly RULE_recordHeader = 76;
    static readonly RULE_recordComponentList = 77;
    static readonly RULE_recordComponent = 78;
    static readonly RULE_recordBody = 79;
    static readonly RULE_block = 80;
    static readonly RULE_blockStatement = 81;
    static readonly RULE_localVariableDeclaration = 82;
    static readonly RULE_identifier = 83;
    static readonly RULE_typeIdentifier = 84;
